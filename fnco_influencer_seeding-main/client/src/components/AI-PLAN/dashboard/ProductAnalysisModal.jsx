...
// API 행 → created_dt 포맷 (YYYY.MM.DD)
                    ...
                    >
                        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                            ...
                            <div>
                                ...
                                >
                                    {t('aiPlan.dashboard.completedPlansModalTitle')}
                                </h2>
                                <p style={{ fontSize: '14px', color: '#6B7280' }}>
                                    {t('aiPlan.dashboard.completedPlansModalSubtitle')}
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            plans.map((plan) => (
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            {t('aiPlan.dashboard.continueEditing')}
